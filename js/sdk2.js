...
// FinalizationRegistry = v_saf(function FinalizationRegistry(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };})
...
AudioDestinationNode = v_saf(function AudioDestinationNode(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(AudioDestinationNode, AudioNode)
...
Object.defineProperties(PerformanceEntry.prototype, {
  duration: {get(){ v_console_log("  [*] PerformanceEntry -> duration[get]", 23.099999964237213);return 23.099999964237213 }},
  name: {get(){ v_console_log("  [*] PerformanceEntry -> name[get]", "https://live.douyin.com/webcast/lottery/melon/lottery_info/?aid=6383&app_name=douyin_web&live_id=1&device_platform=web&language=zh-CN&enter_from=web_live&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=132.0.0.0&room_id=7463187012988799755&query_from=1&msToken=La7TPOQLrbuzdv4550ne2Hdjs3iNOzOwiS31cm1w7V0Ni6S_VikeBUX2z1hM_cbTVoq1MrB9p_yEhLWaZw1mU66Hfz76iC-NssFy9shKy4lmS2gavowSJc-oMFIvskEskTJ_Bf-LV9WQU5NpZ_qrj3eExkvpj2o-LBNkGYjL7-_hdGZgagTx7w%3D%3D&a_bogus=m6s5gH7JOpAfPd%2FG8cJJC5%2Flf86%2FrTWyVFidbnqK9PPpThzTiSNzDObVnooN-3DW-8B0keIHqxe%2FbxVcOdUi1lnpqmkDuMiRGs2Vnwmo0q7DbPvgJqmQeJbEziTG0A4YY5ItNMv56s0K2EcWIr9kApC7w%2FlNRbjdMq-JV2zjT9Km0SWjwn%2F9a5JhxhtqLD%3D%3D");return "https://live.douyin.com/webcast/lottery/melon/lottery_info/?aid=6383&app_name=douyin_web&live_id=1&device_platform=web&language=zh-CN&enter_from=web_live&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=132.0.0.0&room_id=7463187012988799755&query_from=1&msToken=La7TPOQLrbuzdv4550ne2Hdjs3iNOzOwiS31cm1w7V0Ni6S_VikeBUX2z1hM_cbTVoq1MrB9p_yEhLWaZw1mU66Hfz76iC-NssFy9shKy4lmS2gavowSJc-oMFIvskEskTJ_Bf-LV9WQU5NpZ_qrj3eExkvpj2o-LBNkGYjL7-_hdGZgagTx7w%3D%3D&a_bogus=m6s5gH7JOpAfPd%2FG8cJJC5%2Flf86%2FrTWyVFidbnqK9PPpThzTiSNzDObVnooN-3DW-8B0keIHqxe%2FbxVcOdUi1lnpqmkDuMiRGs2Vnwmo0q7DbPvgJqmQeJbEziTG0A4YY5ItNMv56s0K2EcWIr9kApC7w%2FlNRbjdMq-JV2zjT9Km0SWjwn%2F9a5JhxhtqLD%3D%3D" }},
  startTime: {get(){ v_console_log("  [*] PerformanceEntry -> startTime[get]", 20001.400000035763);return 20001.400000035763 }},
  entryType: {get(){ v_console_log("  [*] PerformanceEntry -> entryType[get]", "measure");return "measure" }},
...
Object.defineProperties(Navigator.prototype, {
  userAgent: {get(){ v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36");return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36" }},
  ...
  appVersion: {get(){ v_console_log("  [*] Navigator -> appVersion[get]", "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36");return "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36" }},
...
Object.defineProperties(HTMLAllCollection.prototype, {
  length: {get(){ v_console_log("  [*] HTMLAllCollection -> length[get]", 527);return 527 }},
...
Object.defineProperties(DOMTokenList.prototype, {
  length: {get(){ v_console_log("  [*] DOMTokenList -> length[get]", 9);return 9 }},
...
Object.defineProperties(webkitURL.prototype, {
  ...
  pathname: {get(){ v_console_log("  [*] webkitURL -> pathname[get]", "/webcast/lottery/melon/lottery_info/");return "/webcast/lottery/melon/lottery_info/" },set(){ v_console_log("  [*] webkitURL -> pathname[set]", [].slice.call(arguments));return "/webcast/lottery/melon/lottery_info/" }},
  href: {get(){ v_console_log("  [*] webkitURL -> href[get]", "https://live.douyin.com/cloudpush/update_sender/?device_platform=webapp&aid=6383&channel=channel_pc_web&version_code=170400&version_name=17.4.0&os=web&device_brand=web&device_model=web&device_type=web_device&pc_client_type=1&pc_libra_divert=Windows&update_version_code=170400&support_h265=1&support_dash=0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=132.0.0.0&browser_online=true&engine_name=Blink&engine_version=132.0.0.0&os_name=Windows&os_version=10&cpu_core_num=12&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7401027138381530662&uifid=");return "https://live.douyin.com/cloudpush/update_sender/?device_platform=webapp&aid=6383&channel=channel_pc_web&version_code=170400&version_name=17.4.0&os=web&device_brand=web&device_model=web&device_type=web_device&pc_client_type=1&pc_libra_divert=Windows&update_version_code=170400&support_h265=1&support_dash=0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=132.0.0.0&browser_online=true&engine_name=Blink&engine_version=132.0.0.0&os_name=Windows&os_version=10&cpu_core_num=12&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7401027138381530662&uifid=" }},
  username: {get(){ v_console_log("  [*] webkitURL -> username[get]", "a");return "a" }},
  host: {get(){ v_console_log("  [*] webkitURL -> host[get]", "live.douyin.com");return "live.douyin.com" }},
  hash: {get(){ v_console_log("  [*] webkitURL -> hash[get]", "#%D0%B1");return "#%D0%B1" }},
  hostname: {get(){ v_console_log("  [*] webkitURL -> hostname[get]", "live.douyin.com");return "live.douyin.com" }},
  protocol: {get(){ v_console_log("  [*] webkitURL -> protocol[get]", "https:");return "https:" }},
  search: {get(){ v_console_log("  [*] webkitURL -> search[get]", "");return "" },set(){ v_console_log("  [*] webkitURL -> search[set]", [].slice.call(arguments));return "" }},
...
Object.defineProperties(HTMLCollection.prototype, {
  length: {get(){ v_console_log("  [*] HTMLCollection -> length[get]", 17);return 17 }},
...
Object.defineProperties(Response.prototype, {
  ...
  url: {get(){ v_console_log("  [*] Response -> url[get]", "https://v2nhpuitzo3hcs194c6htin9y5i1y5n8u.mobgslb.tbcache.com/pull-l3.douyincdn.com/third/stream-7463183618781793060_sd5.flv?kabr_spts=-800&major_anchor_level=common&unique_id=stream-7463183618781793060_479_flv_sd5&auth_key=1738289511-0-0-2252408e3bebf4f9c49ce68b470d41da&ali_dispatch_cold_stream=on&ali_redirect_ex_hot=66666100&ali_stream_type=00&ali_stream_type_ring=&ali_orig_station=cn7190&ali_302c=700&ali_st=cn7651&ali_ts=1737686625&_session_id=037-20250124104151266637A4B8BC424EDECC.1737686627177.75815&rsi=1");return "https://v2nhpuitzo3hcs194c6htin9y5i1y5n8u.mobgslb.tbcache.com/pull-l3.douyincdn.com/third/stream-7463183618781793060_sd5.flv?kabr_spts=-800&major_anchor_level=common&unique_id=stream-7463183618781793060_479_flv_sd5&auth_key=1738289511-0-0-2252408e3bebf4f9c49ce68b470d41da&ali_dispatch_cold_stream=on&ali_redirect_ex_hot=66666100&ali_stream_type=00&ali_stream_type_ring=&ali_orig_station=cn7190&ali_302c=700&ali_st=cn7651&ali_ts=1737686625&_session_id=037-20250124104151266637A4B8BC424EDECC.1737686627177.75815&rsi=1" }},
...
Object.defineProperties(Event.prototype, {
  ...
  timeStamp: {get(){ v_console_log("  [*] Event -> timeStamp[get]", 22222.80000001192);return 22222.80000001192 }},
...
Object.defineProperties(NodeList.prototype, {
  length: {get(){ v_console_log("  [*] NodeList -> length[get]", 100);return 100 }},
...
Object.defineProperties(PerformanceTiming.prototype, {
  loadEventEnd: {get(){ v_console_log("  [*] PerformanceTiming -> loadEventEnd[get]", 1737686625893);return 1737686625893 }},
  navigationStart: {get(){ v_console_log("  [*] PerformanceTiming -> navigationStart[get]", 1737686621198);return 1737686621198 }},
...
Object.defineProperties(CanvasRenderingContext2D.prototype, {
  ...
  canvas: {get(){ v_console_log("  [*] CanvasRenderingContext2D -> canvas[get]", {});return {} }},
  ...
  textBaseline: {set(){ v_console_log("  [*] CanvasRenderingContext2D -> textBaseline[set]", [].slice.call(arguments));return {} }},
  font: {set(){ v_console_log("  [*] CanvasRenderingContext2D -> font[set]", [].slice.call(arguments));return {} }},
  fillText: {value: v_saf(function fillText(){v_console_log("  [*] CanvasRenderingContext2D -> fillText[func]", [].slice.call(arguments));})},
  globalCompositeOperation: {set(){ v_console_log("  [*] CanvasRenderingContext2D -> globalCompositeOperation[set]", [].slice.call(arguments));return {} }},
...
Object.defineProperties(DOMRectReadOnly.prototype, {
  left: {get(){ v_console_log("  [*] DOMRectReadOnly -> left[get]", 819);return 819 }},
  top: {get(){ v_console_log("  [*] DOMRectReadOnly -> top[get]", 212);return 212 }},
  right: {get(){ v_console_log("  [*] DOMRectReadOnly -> right[get]", 1115);return 1115 }},
  bottom: {get(){ v_console_log("  [*] DOMRectReadOnly -> bottom[get]", 859);return 859 }},
  width: {get(){ v_console_log("  [*] DOMRectReadOnly -> width[get]", 72);return 72 }},
  height: {get(){ v_console_log("  [*] DOMRectReadOnly -> height[get]", 80);return 80 }},
  x: {get(){ v_console_log("  [*] DOMRectReadOnly -> x[get]", 226);return 226 }},
  y: {get(){ v_console_log("  [*] DOMRectReadOnly -> y[get]", 859);return 859 }},
  toJSON: {value: v_saf(function toJSON(){v_console_log("  [*] DOMRectReadOnly -> toJSON[func]", [].slice.call(arguments));})},
...
Object.defineProperties(VideoPlaybackQuality.prototype, {
  ...
  totalVideoFrames: {get(){ v_console_log("  [*] VideoPlaybackQuality -> totalVideoFrames[get]", 117);return 117 }},
  creationTime: {get(){ v_console_log("  [*] VideoPlaybackQuality -> creationTime[get]", 21843.100000023842);return 21843.100000023842 }},
...
Object.defineProperties(LayoutShiftAttribution.prototype, {
  ...
  previousRect: {get(){ v_console_log("  [*] LayoutShiftAttribution -> previousRect[get]", {});return {} }},
  currentRect: {get(){ v_console_log("  [*] LayoutShiftAttribution -> currentRect[get]", {});return {} }},
...
Object.defineProperties(Node.prototype, {
  ...
  baseURI: {get(){ v_console_log("  [*] Node -> baseURI[get]", "https://live.douyin.com/905644984500");return "https://live.douyin.com/905644984500" }},
...
Object.defineProperties(MessageEvent.prototype, {
  data: {get(){ v_console_log("  [*] MessageEvent -> data[get]", "ACK");return "ACK" }},
  origin: {get(){ v_console_log("  [*] MessageEvent -> origin[get]", "https://lf-zt.douyin.com");return "https://lf-zt.douyin.com" }},
...
Object.defineProperties(PerformanceResourceTiming.prototype, {
  responseStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> responseStart[get]", 35.40000003576279);return 35.40000003576279 }},
  initiatorType: {get(){ v_console_log("  [*] PerformanceResourceTiming -> initiatorType[get]", "xmlhttprequest");return "xmlhttprequest" }},
  decodedBodySize: {get(){ v_console_log("  [*] PerformanceResourceTiming -> decodedBodySize[get]", 2237);return 2237 }},
  responseEnd: {get(){ v_console_log("  [*] PerformanceResourceTiming -> responseEnd[get]", 3333.699999988079);return 3333.699999988079 }},
  encodedBodySize: {get(){ v_console_log("  [*] PerformanceResourceTiming -> encodedBodySize[get]", 14859);return 14859 }},
  transferSize: {get(){ v_console_log("  [*] PerformanceResourceTiming -> transferSize[get]", 0);return 0 }},
  fetchStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> fetchStart[get]", 6.300000011920929);return 6.300000011920929 }},
  redirectStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> redirectStart[get]", 0);return 0 }},
  domainLookupStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> domainLookupStart[get]", 6.300000011920929);return 6.300000011920929 }},
  domainLookupEnd: {get(){ v_console_log("  [*] PerformanceResourceTiming -> domainLookupEnd[get]", 6.300000011920929);return 6.300000011920929 }},
  requestStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> requestStart[get]", 6.300000011920929);return 6.300000011920929 }},
  workerStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> workerStart[get]", 4.600000023841858);return 4.600000023841858 }},
  [Symbol.toStringTag]: {value:"PerformanceResourceTiming",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(DOMRect.prototype, {
  width: {get(){ v_console_log("  [*] DOMRect -> width[get]", 300);return 300 }},
  height: {get(){ v_console_log("  [*] DOMRect -> height[get]", 48);return 48 }},
  x: {get(){ v_console_log("  [*] DOMRect -> x[get]", 800);return 800 }},
...
Object.defineProperties(MediaSource.prototype, {
  readyState: {get(){ v_console_log("  [*] MediaSource -> readyState[get]", "open");return "open" }},
...
Object.defineProperties(SourceBuffer.prototype, {
  ...
  updating: {get(){ v_console_log("  [*] SourceBuffer -> updating[get]", true);return true }},
...
Object.defineProperties(LayoutShift.prototype, {
  ...
  value: {get(){ v_console_log("  [*] LayoutShift -> value[get]", 0.010715374881284804);return 0.010715374881284804 }},
...
Object.defineProperties(AudioNode.prototype, {
  ...
  channelCountMode: {get(){ v_console_log("  [*] AudioNode -> channelCountMode[get]", "max");return "max" }},
  channelInterpretation: {get(){ v_console_log("  [*] AudioNode -> channelInterpretation[get]", "speakers");return "speakers" }},
  numberOfInputs: {get(){ v_console_log("  [*] AudioNode -> numberOfInputs[get]", 1);return 1 }},
  numberOfOutputs: {get(){ v_console_log("  [*] AudioNode -> numberOfOutputs[get]", 1);return 1 }},
...
Object.defineProperties(Document.prototype, {
  ...
  referrer: {get(){ v_console_log("  [*] Document -> referrer[get]", "https://live.douyin.com/");return "https://live.douyin.com/" }},
  ...
  title: {get(){ v_console_log("  [*] Document -> title[get]", "教做菜lIlIll.II I的抖音直播间 - 抖音直播");return "教做菜lIlIll.II I的抖音直播间 - 抖音直播" },set(){ v_console_log("  [*] Document -> title[set]", [].slice.call(arguments));return "教做菜lIlIll.II I的抖音直播间 - 抖音直播" }},
...
Object.defineProperties(Element.prototype, {
  ...
  className: {get(){ v_console_log("  [*] Element -> className[get]", "aqK_4_5U");return "aqK_4_5U" },set(){ v_console_log("  [*] Element -> className[set]", [].slice.call(arguments));return "aqK_4_5U" }},
  ...
  clientWidth: {get(){ v_console_log("  [*] Element -> clientWidth[get]", 514);return 514 }},
  clientHeight: {get(){ v_console_log("  [*] Element -> clientHeight[get]", 957);return 957 }},
  ...
  scrollHeight: {get(){ v_console_log("  [*] Element -> scrollHeight[get]", 632);return 632 }},
...
Object.defineProperties(PerformanceNavigationTiming.prototype, {
  ...
  domContentLoadedEventEnd: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventEnd[get]", 3993.100000023842);return 3993.100000023842 }},
  domContentLoadedEventStart: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventStart[get]", 3990.199999988079);return 3990.199999988079 }},
  domInteractive: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domInteractive[get]", 3948);return 3948 }},
  loadEventStart: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> loadEventStart[get]", 4692.699999988079);return 4692.699999988079 }},
  domComplete: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domComplete[get]", 4680.100000023842);return 4680.100000023842 }},
  loadEventEnd: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> loadEventEnd[get]", 4694.900000035763);return 4694.900000035763 }},
...
Object.defineProperties(AudioDestinationNode.prototype, {
  maxChannelCount: {get(){ v_console_log("  [*] AudioDestinationNode -> maxChannelCount[get]", 2);return 2 }},
...
Object.defineProperties(AnalyserNode.prototype, {
  ...
  maxDecibels: {get(){ v_console_log("  [*] AnalyserNode -> maxDecibels[get]", -30);return -30 }},
  minDecibels: {get(){ v_console_log("  [*] AnalyserNode -> minDecibels[get]", -100);return -100 }},
  smoothingTimeConstant: {get(){ v_console_log("  [*] AnalyserNode -> smoothingTimeConstant[get]", 0.8);return 0.8 }},
...
Object.defineProperties(HTMLElement.prototype, {
  ...
  nonce: {get(){ v_console_log("  [*] HTMLElement -> nonce[get]", "3UUe6AyF2_iNdwpgtnCzi");return "3UUe6AyF2_iNdwpgtnCzi" }},
  ...
  innerText: {get(){ v_console_log("  [*] HTMLElement -> innerText[get]", "");return "" },set(){ v_console_log("  [*] HTMLElement -> innerText[set]", [].slice.call(arguments));return "" }},
  ...
  offsetHeight: {get(){ v_console_log("  [*] HTMLElement -> offsetHeight[get]", 632);return 632 }},
  offsetWidth: {get(){ v_console_log("  [*] HTMLElement -> offsetWidth[get]", 300);return 300 }},
...
Object.defineProperties(HTMLLinkElement.prototype, {
  ...
  rel: {get(){ v_console_log("  [*] HTMLLinkElement -> rel[get]", "preconnect");return "preconnect" },set(){ v_console_log("  [*] HTMLLinkElement -> rel[set]", [].slice.call(arguments));return "preconnect" }},
  type: {set(){ v_console_log("  [*] HTMLLinkElement -> type[set]", [].slice.call(arguments));return "preconnect" }},
  href: {set(){ v_console_log("  [*] HTMLLinkElement -> href[set]", [].slice.call(arguments));return "preconnect" }},
...
Object.defineProperties(HTMLScriptElement.prototype, {
  ...
  src: {get(){ v_console_log("  [*] HTMLScriptElement -> src[get]", "chrome-extension://onepmapfbjohnegdmfhndpefjkppbjkm/sm.bundle.js");return "chrome-extension://onepmapfbjohnegdmfhndpefjkppbjkm/sm.bundle.js" },set(){ v_console_log("  [*] HTMLScriptElement -> src[set]", [].slice.call(arguments));return "chrome-extension://onepmapfbjohnegdmfhndpefjkppbjkm/sm.bundle.js" }},
  crossOrigin: {set(){ v_console_log("  [*] HTMLScriptElement -> crossOrigin[set]", [].slice.call(arguments));return "chrome-extension://onepmapfbjohnegdmfhndpefjkppbjkm/sm.bundle.js" }},
  type: {set(){ v_console_log("  [*] HTMLScriptElement -> type[set]", [].slice.call(arguments));return "chrome-extension://onepmapfbjohnegdmfhndpefjkppbjkm/sm.bundle.js" }},
...
Object.defineProperties(HTMLMediaElement.prototype, {
  ...
  autoplay: {set(){ v_console_log("  [*] HTMLMediaElement -> autoplay[set]", [].slice.call(arguments));return 0.6 }},
  muted: {get(){ v_console_log("  [*] HTMLMediaElement -> muted[get]", true);return true },set(){ v_console_log("  [*] HTMLMediaElement -> muted[set]", [].slice.call(arguments));return true }},
  currentTime: {get(){ v_console_log("  [*] HTMLMediaElement -> currentTime[get]", 3.860667);return 3.860667 },set(){ v_console_log("  [*] HTMLMediaElement -> currentTime[set]", [].slice.call(arguments));return 3.860667 }},
  src: {get(){ v_console_log("  [*] HTMLMediaElement -> src[get]", "blob:https://live.douyin.com/f076269b-dfa8-4c82-9b00-6c8b2011877a");return "blob:https://live.douyin.com/f076269b-dfa8-4c82-9b00-6c8b2011877a" },set(){ v_console_log("  [*] HTMLMediaElement -> src[set]", [].slice.call(arguments));return "blob:https://live.douyin.com/f076269b-dfa8-4c82-9b00-6c8b2011877a" }},
  readyState: {get(){ v_console_log("  [*] HTMLMediaElement -> readyState[get]", 4);return 4 }},
  currentSrc: {get(){ v_console_log("  [*] HTMLMediaElement -> currentSrc[get]", "blob:https://live.douyin.com/f076269b-dfa8-4c82-9b00-6c8b2011877a");return "blob:https://live.douyin.com/f076269b-dfa8-4c82-9b00-6c8b2011877a" }},
...
Object.defineProperties(HTMLInputElement.prototype, {
  ...
  checked: {set(){ v_console_log("  [*] HTMLInputElement -> checked[set]", [].slice.call(arguments));return "" }},
  defaultChecked: {set(){ v_console_log("  [*] HTMLInputElement -> defaultChecked[set]", [].slice.call(arguments));return "" }},
  name: {set(){ v_console_log("  [*] HTMLInputElement -> name[set]", [].slice.call(arguments));return "" }},
...
Object.defineProperties(HTMLTextAreaElement.prototype, {
  defaultValue: {set(){ v_console_log("  [*] HTMLTextAreaElement -> defaultValue[set]", [].slice.call(arguments)); }},
...
Object.defineProperties(HTMLVideoElement.prototype, {
  disablePictureInPicture: {get(){ v_console_log("  [*] HTMLVideoElement -> disablePictureInPicture[get]", false);return false }},
  videoWidth: {get(){ v_console_log("  [*] HTMLVideoElement -> videoWidth[get]", 720);return 720 }},
  videoHeight: {get(){ v_console_log("  [*] HTMLVideoElement -> videoHeight[get]", 1280);return 1280 }},
...
function _createElement(name){
  var htmlmap = {"HTMLElement":["abbr","address","article","aside","b","bdi","bdo","cite","code","dd","dfn","dt","em","figcaption","figure","footer","header","hgroup","i","kbd","main","mark","nav","noscript","rp","rt","ruby","s","samp","section","small","strong","sub","summary","sup","u","var","wbr"],"HTMLLinkElement":["link"],"HTMLScriptElement":["script"],"HTMLAnchorElement":["a"],"HTMLStyleElement":["style"],"HTMLCanvasElement":["canvas"],"HTMLMediaElement":[],"HTMLImageElement":["img"],"HTMLInputElement":["input"],"HTMLTextAreaElement":["textarea"],"HTMLIFrameElement":["iframe"],"HTMLVideoElement":["video"],"HTMLHeadElement":["head"],"HTMLBodyElement":["body"],"HTMLUnknownElement":[]}
...
init_cookie("SEARCH_RESULT_LIST_TYPE=%22single%22; UIFID=; hevc_supported=true; my_rd=2; x-web-secsdk-uid=2b36a84e-25ef-4575-8818-161f46d8ac49; has_avx2=null; device_web_cpu_core=12; device_web_memory_size=8; live_use_vvc=%22false%22; xgplayer_user_id=542572075184; csrf_session_id=9e72449d44db1782b2f12b05f4856819; h265ErrorNum=-1; volume_info=%7B%22isMute%22%3Atrue%2C%22isUserMute%22%3Atrue%2C%22volume%22%3A0.6%7D; fpk1=U2FsdGVkX19Sik5LMi0o5Ibb6HLRSmJia1UtzQ9m/0TYH1sd2QmkWP3Moe70ZZAl6407Y/UKe1HffaZWoh7peQ==; fpk2=41770e408d453f0e18b6cf535e220c84; webcast_local_quality=sd; download_guide=%223%2F20250118%2F1%22; webcast_leading_last_show_time=1737379447541; webcast_leading_total_show_times=2; stream_recommend_feed_params=%22%7B%5C%22cookie_enabled%5C%22%3Atrue%2C%5C%22screen_width%5C%22%3A1920%2C%5C%22screen_height%5C%22%3A1080%2C%5C%22browser_online%5C%22%3Atrue%2C%5C%22cpu_core_num%5C%22%3A12%2C%5C%22device_memory%5C%22%3A8%2C%5C%22downlink%5C%22%3A10%2C%5C%22effective_type%5C%22%3A%5C%224g%5C%22%2C%5C%22round_trip_time%5C%22%3A100%7D%22; passport_csrf_token=7999860f633fcaa47e379422d8f89cab; passport_csrf_token_default=7999860f633fcaa47e379422d8f89cab; bd_ticket_guard_client_web_domain=2; home_can_add_dy_2_desktop=%221%22; xg_device_score=7.802204888412783; __ac_nonce=06792fda000d54606d98f; __ac_signature=_02B4Z6wo00f01LX5mQAAAIDDCCl5GzIm-pi12Z2AAErx01; __live_version__=%221.1.2.7886%22; FORCE_LOGIN=%7B%22videoConsumedRemainSeconds%22%3A180%2C%22isForcePopClose%22%3A1%7D; __security_mc_1_s_sdk_crypt_sdk=28478975-4a87-a877; __security_mc_1_s_sdk_cert_key=8592730e-49ca-93f8; biz_trace_id=9a829e55; sdk_source_info=; bit_env=9Ow6-MYVexreYF_gqD3VNv50b_UfyqY8qqtOWEoj0LxWcg6dblDJpFkrtQqluGzUbAj7v2Tmjzj1GkV5jKRIFhtVqjvr_w2B8P984A-fkUVpum2lSuyO0_XOHCEjuI8sWB8DInStSoCvRnGx9Q2GgpCY9uPO0HCM_fhKgeiQlN5GzB4coMk29fjNODf9TOT7jCMjUTeH7n-9FwBDS_bX6p0rTzjI-b3Rd1DOLU6MqCrGaMYnu0MxC69ISkEMjmAJurhCSRYj8sJrTI4eh2nEo4jHm5vKa9bEZ4RzmtHB9VQCCfz65nh2gN5QosJwSjAAHmryFAozhNW6ngGvjFlUcSwotg_f5UvHG6k_Sq25bcfe8qfPLjXYnSI1Pcy-Pgs6rBAyDyBndl3f_ehSXnaW35qYqKlRt6iOo3Izh9HLgzWA8vuSfSWm9HuC9vBYxVNzvcJEZRuX5oFkAmfbv_uDXY-QhemrA1dEHfHRuz4MqQLARfIbh2XZNaUVBwFcblE2; gulu_source_res=eyJwX2luIjoiMGFlMWE3M2ZhMmUzMjFiMWEzNDkxZGU4MDQ1ZTY3ZTk1N2ExNDAzNmVkYjc3ZmY5YTk5ZTQ2Yjg0NDdjYWM5ZCJ9; passport_auth_mix_state=nfahnknfkvv7sapfjj0yhuw7bd82wi58; passport_assist_user=CkGZe0Msc6ihBh972TPZ_VXgbEbRlxoLhsTCJ3S_uL6ALNMd9GooucJ3WQNlM8dtRrNjIdaPa5AfI7_to1OrvL9qZBpKCjxMNdySbyFrxHr7xBsT93rnIeY--y4YFaPNwK8kaTPr93Fz7O52RpRhOYdPSBfukgVs7eIg2EmsyZr41jQQ99TnDRiJr9ZUIAEiAQNhwE04; __security_mc_1_s_sdk_sign_data_key_sso=c4ebf24b-42d8-9b18; login_time=1737686486380; SelfTabRedDotControl=%5B%5D; publish_badge_show_info=%220%2C0%2C0%2C1737686493541%22; _bd_ticket_crypt_doamin=2; _bd_ticket_crypt_cookie=10301cada1db2c26d508fa830d0cecd5; __security_mc_1_s_sdk_sign_data_key_web_protect=c6548ab6-4068-8686; __security_server_data_status=1; WallpaperGuide=%7B%22showTime%22%3A1737384183090%2C%22closeTime%22%3A0%2C%22showCount%22%3A2%2C%22cursor1%22%3A29%2C%22cursor2%22%3A8%2C%22hoverTime%22%3A1737122205604%7D; passport_fe_beating_status=false; live_can_add_dy_2_desktop=%221%22; IsDouyinActive=true; bd_ticket_guard_client_data=%3D%3D")
v_hook_href(window.location, 'location', "https://live.douyin.com/905644984500")
Location.prototype.toString = v_saf(function toString(){ return "https://live.douyin.com/905644984500" })
...
function v_getele(name, func){
  ...
  if(name == "island_2b4f8" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_d5789" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_4a5da" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_c5bac" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "xg-left-grid" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == "xg-center-grid" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == "xg-right-grid" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == "xg-inner-controls" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == ".xgplayer-icon" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == ".xg-tips" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == ".xgplayer-drag" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == "xg-loading-inner" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == "#chatroom" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "douyin-header" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "canvas" && func == "querySelector"){ return v_new(HTMLCanvasElement) }
  if(name == "xgmask" && func == "querySelector"){ return v_new(HTMLUnknownElement) }
  if(name == "island_4264f" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == ".xg-left-grid" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == ".xg-right-grid" && func == "querySelector"){ return v_new(HTMLElement) }
  if(name == "island_05c91" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_56399" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_a6d2d" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_5ccdd" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_d3bbb" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_3532e" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_80487" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_5db2e" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_d96bc" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_9c71a" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_a345b" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_f6f63" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_4c458" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_2aa01" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_55b4b" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_aec52" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_d1d4a" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "island_a74ce" && func == "getElementById"){ return v_new(HTMLElement) }
  ...
  if(name == "living_room_player_container7463187012988799755" && func == "getElementById"){ return v_new(HTMLDivElement) }
  if(name == "#_douyin_live_scroll_container_" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "island_4aba7" && func == "getElementById"){ return v_new(HTMLElement) }
  if(name == "meta[name=\"theme-color\"]" && func == "querySelector"){ return v_new(HTMLMetaElement) }
  if(name == ".webcast-chatroom___list" && func == "querySelector"){ return v_new(HTMLDivElement) }
  if(name == "island_8cd31" && func == "getElementById"){ return v_new(HTMLElement) }
  return null
}
function v_geteles(name, func){
  if(name == "head" && func == "getElementsByTagName"){ return [v_new(HTMLHeadElement)] }
  if(name == "script" && func == "getElementsByTagName"){ return [v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement)] }
  if(name == "link" && func == "getElementsByTagName"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  ...
  if(name == "style" && func == "getElementsByTagName"){ return [v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement)] }
  if(name == "[rel=preload]" && func == "querySelectorAll"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  if(name == ".giftRechargeContaner" && func == "querySelectorAll"){ return [v_new(HTMLDivElement)] }
  return null
}
var v_Date = Date;
...
function get_sign(a) {
    // o = ',live_id=1,aid=6383,version_code=180800,webcast_sdk_version=1.0.14-beta.0,room_id=7463187012988799755,sub_room_id=,sub_channel_id=,did_rule=3,user_unique_id=7401027138381530662,device_platform=web,device_type=,ac=,identity=audience'

    // let a = CryptoJs.MD5(o.substring(1)).toString();

    const data = {
    "X-MS-STUB": a
    }

    let ret = window.xxx(data);

    return ret["X-Bogus"];
}

let r = get_sign(process.argv[2])
console.log(r)
